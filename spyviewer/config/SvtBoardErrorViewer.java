...
public class SvtBoardErrorViewer extends SvtBoardErrorFrame {
  private MessageThread mThread = null;

  public SvtBoardErrorViewer(boolean standAlone, boolean connectOnStartup) {
    super(standAlone);
  ...
  public static void main(String [] argv) {
    ...
    SvtBoardErrorViewer gui = new SvtBoardErrorViewer(true, connOnStartup);
    gui.setSize(800, 650);
    gui.setVisible(true);
  }
}