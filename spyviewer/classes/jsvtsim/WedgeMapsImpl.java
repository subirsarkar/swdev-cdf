...
public class WedgeMapsImpl {
  ...
  public static native int svtsim_initMaps(final wedgemaps_t self, int wedge,
                                String ifitFnal, String pattFnam, String ssFnam);
  public static native int svtsim_initFromMapSet(final wedgemaps_t self,  
                          int wedge, final String mapSetName, final long mapSetCrc,
                          final String dlPath, final boolean usedb);
  public static native int svtsim_useHwSet(final wedgemaps_t self,  
                          int wedge, final String hwSetName, final long hwSetCrc,
                          final String dlPath, final boolean usedb);
