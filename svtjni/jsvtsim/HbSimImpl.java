...
public class HbSimImpl {
  ...
  public static native void svtsim_hb_plugHitInput(final hbsim_t self, final cable_t cable);
  public static native void svtsim_hb_plugRoadInput(final hbsim_t self, final cable_t cable);
  public static native cable_t svtsim_hb_outputCable(final hbsim_t self);
  public static native void svtsim_hb_useMaps(final hbsim_t self, final wedgemaps_t maps);
}