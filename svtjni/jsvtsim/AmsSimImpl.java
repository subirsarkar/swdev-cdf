...
public class AmsSimImpl {
  ...
  public static native void svtsim_ams_plugInput(final amssim_t self, final cable_t cable);
  public static native cable_t svtsim_ams_outputCable(final amssim_t self);
  public static native void svtsim_ams_useMaps(final amssim_t self, final wedgemaps_t maps);
