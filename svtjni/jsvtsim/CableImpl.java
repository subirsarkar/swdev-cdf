...
public class CableImpl {
  ...
  public static native void svtsim_cable_copywords(final cable_t self, final int [] words, int nword);
  public static native void svtsim_cable_addwords(final cable_t self, final int [] words, int nword);
