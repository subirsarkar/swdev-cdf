...
public class TfSimImpl {
  ...
  public static native void svtsim_tf_plugInput(final tfsim_t self, final cable_t cable);
  public static native cable_t svtsim_tf_outputCable(final tfsim_t self);
  public static native void svtsim_tf_useMaps(final tfsim_t self, final wedgemaps_t maps);
}
